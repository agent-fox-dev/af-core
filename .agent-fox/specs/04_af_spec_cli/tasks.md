...
- [ ] 1. Write failing spec tests
  ...
  - [ ] 1.3 Translate spec new command tests
  ...
  - [ ] 1.4 Translate assess and refine command tests
  ...
  - [ ] 1.5 Translate accept, generate, validate, render, show, status tests
  ...
  - [ ] 1.6 Translate cross-cutting and resolution tests
...
- [ ] 2. Implement CLI shared infrastructure
  - [ ] 2.1 Implement main Click group and context
  ...
  - [ ] 2.2 Implement resolve_campaign helper
  ...
  - [ ] 2.3 Implement resolve_spec helper
  ...
  - [ ] 2.4 Implement error handling wrapper
  ...
  - [ ] 2.5 Implement output formatting helpers
...
- [ ] 3. Implement campaign commands
  - [ ] 3.1 Implement init command
...
- [ ] 4. Implement spec authoring commands (new, assess, refine, accept)
  - [ ] 4.1 Implement new command
...
- [ ] 5. Implement spec lifecycle commands (generate, validate, render, show, status)
  - [ ] 5.1 Implement generate command
...
- [ ] 6. Wiring verification
  ...
  - [ ] 6.4 Run the integration smoke tests
    - All TS-04-SMOKE-* tests pass with real components
    - _Test Spec: TS-04-SMOKE-1 through TS-04-SMOKE-4_

  - [ ] 6.5 Stub / dead-code audit
  ...
  - [ ] 6.6 Cross-spec entry point verification
...
|-------------|-----------------|---------------------|------------------|
| 04-REQ-1.1 | TS-04-1 | 3.1 | tests/test_cli.py::test_init_creates_campaign |
| 04-REQ-1.2 | TS-04-2 | 3.1 | tests/test_cli.py::test_init_defaults_name_to_basename |
| 04-REQ-1.3 | TS-04-3 | 3.1 | tests/test_cli.py::test_init_defaults_description_empty |
| 04-REQ-1.4 | TS-04-4 | 3.1 | tests/test_cli.py::test_init_handles_campaign_error |
| 04-REQ-1.E1 | TS-04-5 | 3.1 | tests/test_cli.py::test_init_resolves_relative_path |
| 04-REQ-2.1 | TS-04-6 | 3.2 | tests/test_cli.py::test_list_displays_table |
| 04-REQ-2.2 | TS-04-7 | 3.2 | tests/test_cli.py::test_list_explicit_directory |
| 04-REQ-2.3 | TS-04-8 | 3.2 | tests/test_cli.py::test_list_empty_campaign |
| 04-REQ-2.4 | TS-04-9 | 3.2 | tests/test_cli.py::test_list_sorts_by_prefix |
| 04-REQ-2.E1 | TS-04-10 | 3.2 | tests/test_cli.py::test_list_error_non_campaign |
| 04-REQ-3.1 | TS-04-11 | 4.1 | tests/test_cli.py::test_new_creates_spec |
| 04-REQ-3.2 | TS-04-12, TS-04-13 | 4.1 | tests/test_cli.py::test_new_explicit_name, test_new_derives_name |
| 04-REQ-3.3 | TS-04-14 | 4.1 | tests/test_cli.py::test_new_one_shot |
| 04-REQ-3.4 | TS-04-15 | 4.1 | tests/test_cli.py::test_new_missing_prd |
| 04-REQ-3.E1 | TS-04-16 | 4.1 | tests/test_cli.py::test_new_invalid_name |
| 04-REQ-4.1 | TS-04-17 | 4.2 | tests/test_cli.py::test_assess_runs_and_prints |
| 04-REQ-4.2 | TS-04-18 | 4.2 | tests/test_cli.py::test_assess_output_formatting |
| 04-REQ-4.3 | TS-04-19 | 4.2 | tests/test_cli.py::test_assess_wrong_state |
| 04-REQ-4.E1 | TS-04-20 | 4.2 | tests/test_cli.py::test_assess_agent_error |
| 04-REQ-5.1 | TS-04-21 | 4.3 | tests/test_cli.py::test_refine_submits_answers |
| 04-REQ-5.2 | TS-04-22 | 4.3 | tests/test_cli.py::test_refine_missing_answers_file |
| 04-REQ-5.3 | TS-04-23 | 4.3 | tests/test_cli.py::test_refine_invalid_json |
| 04-REQ-5.4 | TS-04-24 | 4.3 | tests/test_cli.py::test_refine_wrong_state |
| 04-REQ-5.5 | TS-04-25 | 4.3 | tests/test_cli.py::test_refine_prints_updated_assessment |
| 04-REQ-5.E1 | TS-04-26 | 4.3 | tests/test_cli.py::test_refine_invalid_schema |
| 04-REQ-6.1 | TS-04-27 | 4.4 | tests/test_cli.py::test_accept_transitions_state |
| 04-REQ-6.2 | TS-04-28 | 4.4 | tests/test_cli.py::test_accept_wrong_state |
| 04-REQ-7.1 | TS-04-29 | 5.1 | tests/test_cli.py::test_generate_runs_and_prints |
| 04-REQ-7.2 | TS-04-29 | 5.1 | tests/test_cli.py::test_generate_runs_and_prints |
| 04-REQ-7.3 | TS-04-30 | 5.1 | tests/test_cli.py::test_generate_wrong_state |
| 04-REQ-7.E1 | TS-04-31 | 5.1 | tests/test_cli.py::test_generate_agent_error |
| 04-REQ-8.1 | TS-04-32 | 5.2 | tests/test_cli.py::test_validate_passing |
| 04-REQ-8.2 | TS-04-32 | 5.2 | tests/test_cli.py::test_validate_passing |
| 04-REQ-8.3 | TS-04-33 | 5.2 | tests/test_cli.py::test_validate_with_errors |
| 04-REQ-8.4 | TS-04-33 | 5.2 | tests/test_cli.py::test_validate_with_errors |
| 04-REQ-8.E1 | TS-04-34 | 5.2 | tests/test_cli.py::test_validate_missing_artifacts |
| 04-REQ-9.1 | TS-04-35 | 5.3 | tests/test_cli.py::test_render_outputs_markdown |
| 04-REQ-9.2 | TS-04-36 | 5.3 | tests/test_cli.py::test_render_combined |
| 04-REQ-9.3 | TS-04-37 | 5.3 | tests/test_cli.py::test_render_without_combined |
| 04-REQ-9.E1 | TS-04-38 | 5.3 | tests/test_cli.py::test_render_missing_artifacts |
| 04-REQ-10.1 | TS-04-39 | 5.5 | tests/test_cli.py::test_status_all_specs |
| 04-REQ-10.2 | TS-04-40 | 5.5 | tests/test_cli.py::test_status_single_spec |
| 04-REQ-10.3 | TS-04-41 | 5.4 | tests/test_cli.py::test_show_session_state |
| 04-REQ-10.4 | TS-04-42 | 5.4 | tests/test_cli.py::test_show_artifact_content |
| 04-REQ-10.5 | TS-04-43 | 5.4 | tests/test_cli.py::test_show_nonexistent_artifact |
| 04-REQ-10.E1 | TS-04-44 | 2.3 | tests/test_cli.py::test_spec_not_found_lists_available |
| 04-REQ-CC.1 | TS-04-45 | 2.1 | tests/test_cli.py::test_campaign_dir_option_overrides_cwd |
| 04-REQ-CC.2 | TS-04-45 | 2.1 | tests/test_cli.py::test_campaign_dir_option_overrides_cwd |
| 04-REQ-CC.3 | TS-04-46 | 2.2 | tests/test_cli.py::test_no_campaign_dir_error |
| 04-REQ-CC.4 | TS-04-47, TS-04-48 | 2.3 | tests/test_cli.py::test_spec_resolved_by_full_name, test_spec_resolved_by_number |
| 04-REQ-CC.5 | TS-04-44 | 2.3 | tests/test_cli.py::test_spec_not_found_lists_available |
| 04-REQ-CC.6 | TS-04-49, TS-04-50, TS-04-51 | 2.4 | tests/test_cli.py::test_exit_code_* |
| Property 1 | TS-04-P1 | 2.3 | tests/test_cli.py::test_property_spec_resolution_determinism |
| Property 2 | TS-04-P2 | 2.4 | tests/test_cli.py::test_property_error_commands_nonzero_exit |
| Property 3 | TS-04-P3 | 2.1 | tests/test_cli.py::test_property_campaign_dir_precedence |
| Property 4 | TS-04-P4 | 3.1 | tests/test_cli.py::test_property_init_no_overwrite |
| Property 5 | TS-04-P5 | 4.2, 4.3, 4.4, 5.1 | tests/test_cli.py::test_property_state_gate_enforcement |
| Path 1+2 | TS-04-SMOKE-1 | 3.1, 3.2 | tests/test_cli.py::test_smoke_init_and_list |
| Path 3+11 | TS-04-SMOKE-2 | 4.1, 5.5 | tests/test_cli.py::test_smoke_new_and_status |
| Path 10 | TS-04-SMOKE-3 | 5.4 | tests/test_cli.py::test_smoke_show_artifact |
| Path 8+9 | TS-04-SMOKE-4 | 5.2, 5.3 | tests/test_cli.py::test_smoke_validate_and_render |
